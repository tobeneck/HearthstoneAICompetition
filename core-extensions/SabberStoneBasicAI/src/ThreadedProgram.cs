...
namespace SabberStoneBasicAI
{
	internal class Program
	{
		...
		private static void Main()
		{
			...
			CardClass player1Class = CardClass.WARRIOR;
			List<Card> player1Deck = Decks.AggroPirateWarrior;

			AbstractAgent player2 = new DynamicLookaheadAgent();//new DynamicLookaheadAgent(); GreedyAgent
			int nrGames = 10;

			Thread thr1 = new Thread(Program.runOneThread);//whats a programming project whithout wild casting between datatypes?
			Thread thr2 = new Thread(Program.runOneThread);

			List<object> p1 = new List<object>{nrGames, 1, player1, player2, player1Class, player1Deck};
			List<object> p2 = new List<object>{nrGames, 2, player1, player2, player1Class, player1Deck};
			object params1 = p1;
			object params2 = p2;
		...
		public static void runOneThread(object parameters){
			List<object> objectList = (List<object>)parameters;//TODO: cast the object to a list
			int nrGames = (int)objectList[0];
			int startPlayer = (int)objectList[1];
			AbstractAgent player1 = (AbstractAgent)objectList[2];
			AbstractAgent player2 = (AbstractAgent)objectList[3];
			CardClass player1Class = (CardClass)objectList[4];
			List<Card> player1Deck = (List<Card>)objectList[5];

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.MAGE, player1Deck, Decks.RenoKazakusMage);

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.WARRIOR, player1Deck, Decks.AggroPirateWarrior);

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.DRUID, player1Deck, Decks.MurlocDruid);

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.SHAMAN, player1Deck, Decks.MidrangeJadeShaman);

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.PALADIN, player1Deck, Decks.MidrangeBuffPaladin);

			//error in the hunter? -> hunter is not evaluated in 2020 and throws some errors
			//TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.HUNTER, player1Deck, Decks.MidrangeSecretHunter);

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.WARLOCK, player1Deck, Decks.ZooDiscardWarlock);

			//error in the rougue?
			//TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.ROGUE, player1Deck, Decks.MiraclePirateRogue); //ERROR!

			TestPOGame(nrGames, startPlayer, player1, player2, player1Class, CardClass.PRIEST, player1Deck, Decks.RenoKazakusDragonPriest);
		}
